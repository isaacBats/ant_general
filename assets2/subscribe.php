...
if($_POST) {
    ...
    $emailTo = 'nacional@general.com.mx';
	
	// Enter error message
	$varError =' *Por favor, introduzca una dirección válida de correo electrónico'; 
	
	// Enter succes message
	$varSucces ='GRACIAS POR SUSCRIBIRSE A NUESTRO BOLETÍN'; 
	...
	$body = "Usted tiene un nuevo suscriptor de su Página!\n\nEmail: " . $subscriber_email;
