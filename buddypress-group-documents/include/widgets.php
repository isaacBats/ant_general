...
class BP_Group_Documents_Newest_Widget extends WP_Widget {
	...
	$document_list = BP_Group_Documents::get_list_for_newest_widget( $instance['num_items'], $instance['group_filter'] ); 
...
class BP_Group_Documents_Popular_Widget extends WP_Widget {
	...
	$document_list = BP_Group_Documents::get_list_for_popular_widget( $instance['num_items'], $instance['group_filter'] ); 
