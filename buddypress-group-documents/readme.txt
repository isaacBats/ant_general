...
BACK UP YOUR DOCUMENTS BEFORE UPGRADING!!!

PLEASE DOWNLOAD THE PLUGIN AND UPGRADE MANUALLY!!!

For all releases prior to 0.3, the document storage folder may be deleted if you use one-click upgrade.  

Starting with version 0.3.0, the documents have moved to a new storage location.  If you have existing documents with broken links after upgrading, visit the admin screen, and the plugin will automatically move files from the old location to the new one.
