        ...
        <html xmlns="http://www.w3.org/1999/xhtml" <?php language_attributes(); ?>>
            <head>
                ...
                <script> 
					...
					var Lat = Number(<?php echo gmwd_get_option("_lat");?>);
					var Lng = Number(<?php echo gmwd_get_option("_lng");?>);
					var Address = '<?php echo gmwd_get_option("_address");?>';
					var map;				 
                </script>           
                    ...
                    <div class="gmwd_wizard_container gmwd_wizard_default_container">                   
						...
						<div class="wd-clear">
							<div class="wd-left" style="width:412px;">
								<table class="gmwd_edit_table" style="width: 100%;">
									<tr>
										<td style="width: 20%;"><label for="address" title="<?php _e("Set  Address of your Google Map","gmwd");?>"><?php _e(" address","gmwd");?>:</label></td>
										<td>
                                            <input type="text" name="_address" id="address"
											value="" autocomplete="off"><br>
                                            <small><em><?php _e("Or Right Click on the Map.","gmwd");?></em></small>
                                        </td>
									</tr>
									<tr>
										<td><label for="_lat" title="<?php _e("Google Map's  Latitude","gmwd");?>"><?php _e(" Lat","gmwd");?>:</label></td>
										<td><input type="text" name="_lat" id="_lat"
											value=""></td>
									</tr>
									<tr>
										<td><label for="_lng" title="<?php _e("Google Map's  Longitude","gmwd");?>"><?php _e(" Lng","gmwd");?>:</label></td>
										<td><input type="text" name="_lng" id="_lng"
											value=""></td>
									</tr>
									<tr>
