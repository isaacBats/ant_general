<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	$config['grocery_crud_file_upload_allow_file_types'] 		= 'gif|svg|jpeg|jpg|png|pdf|xls|xlsx';
	$config['grocery_crud_file_upload_max_file_size'] 			= '40MB'; //ex. '10MB' (Mega Bytes), '1067KB' (Kilo Bytes), '5000B' (Bytes)
