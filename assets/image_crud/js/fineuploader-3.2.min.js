...
qq.FineUploader=function(a){qq.FineUploaderBasic.apply(this,arguments);qq.extend(this._options,{element:null,listElement:null,dragAndDrop:{extraDropzones:[],hideDropzones:!0,disableDefaultDropzone:!1},text:{uploadButton:"Cargar archivo(s)",cancelButton:"Cancelar",retryButton:"Retry",failUpload:"Carga fallida",dragZone:"Arrastrar archivos aqui para cargar",dropProcessing:"Procesando archivos...",formatProgress:"{percent}% de {total_size}",waitingForResponse:"Procesando..."},template:'<div class="qq-uploader">'+
